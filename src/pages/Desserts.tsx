...
const PRODUCTS: Product[] = [
  { id: 10, category: "DESSERT", name: "라즈베리 쇼콜라", price: 5900, imgUrl: "./assets/image/bread/라즈베리_쇼콜라.jpeg" },
  { id: 11, category: "DESSERT", name: "클래식 스콘", price: 6000, imgUrl: "./assets/image/bread/클래식_스콘.jpeg" },
  { id: 12, category: "DESSERT", name: "티라미수 크림 데니쉬", price: 5800, imgUrl: "./assets/image/bread/티라미수_크림_데니쉬.jpeg" },
];
